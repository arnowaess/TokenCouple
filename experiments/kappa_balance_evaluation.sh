...
cd ..
python3 main_mvclustering.py --concat_heads True --dataset VOC07 --set trainval --which_features $feature --kernel linear --normalize l2 --tau_kernel $tau --binary_graph --rho $rho --assign_func $assign --kappa $kappa --eta $eta
...
python3 get_saliency.py --concat_heads True --dataset ECSSD --out-dir ECSSD --sigma-spatial 16 --sigma-luma 16 --sigma-chroma 8 --vit-feat $feature --kernel linear --normalize l2 --tau_kernel $tau --binary_graph --rho $rho --assign_func $assign --kappa $kappa --eta $eta
